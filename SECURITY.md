...
This is the default policy for haruhimemoe repositories that don't have their own `SECURITY.md`. Report problems in third-party services (osu!, the beatmap mirror) to them.
